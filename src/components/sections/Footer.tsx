  ...
  return (
    <footer className="bg-[#042f2e] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Tagline */}
        <div className="mb-12">
          <h5 className="text-xl sm:text-2xl font-bold text-white/90 max-w-lg leading-snug">
            &ldquo;Your creativity deserves protection as strong as your
            imagination.&rdquo;
          </h5>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 mb-12">
          {/* Company */}
          <div>
            <h6 className="text-sm font-semibold text-teal-400 uppercase tracking-wider mb-4">
              Company
            </h6>
